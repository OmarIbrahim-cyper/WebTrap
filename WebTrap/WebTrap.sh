...
##   WebTrap 	: 	Automated Phishing Tool
##   Author 	: 	Bad Villain 
##   Version 	: 	1.0


## Copyright (C) 2022  Bad Villain
...
banner() {
	cat <<- EOF
		...
		${GREEN}[${WHITE}-${GREEN}]${CYAN} Tool Created by Bad Villain {WHITE}
	EOF
}
...
about() {
	{ clear; banner; echo; }
	cat <<- EOF
		${GREEN}Author   ${RED}:  ${ORANGE}Bad Villain ${RED}[ ${ORANGE}WebTrap ${RED}]
